...
import { Home, BookOpen, Palette, Code, Plane, Lightbulb, Heart, TrendingUp, Clock, User, ChevronDown } from 'lucide-react';
...
const categories = [
  { name: 'Opinion', icon: Code, color: 'bg-blue-500' },
        ...
        <div className="space-y-3 mb-6">
          {!isCollapsed && (
            <motion.div
              ...
              className="flex items-center justify-between text-sm font-medium text-sidebar-foreground/70 uppercase tracking-wider cursor-pointer select-none"
              whileHover={{ color: 'var(--sidebar-primary)' }}
            >
              <h3 className="overflow-hidden whitespace-nowrap">
                Categories
              </h3>
              <motion.div
                initial={false}
        ...
        <div className="space-y-3 mb-6">
          {!isCollapsed && (
            ...
            >
              ...
              <motion.div
                initial={false}
                animate={{ rotate: isAuthorsOpen ? 0 : -90 }}
                transition={{ duration: 0.2 }}
              >
                <ChevronDown className="h-4 w-4" />
              </motion.div>
